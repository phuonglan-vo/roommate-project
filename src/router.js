...
const ROUTES = Object.freeze([
  {
    ...
    page: 'dashboard',
    title: 'Dashboard',
    modulePath: './pages/dashboard-page.js'
  },
  {
    path: '/rooms',
    page: 'rooms',
    title: 'Quản lý phòng',
    modulePath: './pages/rooms-page.js'
  },
  {
    path: '/tenants',
    page: 'tenants',
    title: 'Quản lý người thuê',
    modulePath: './pages/tenants-page.js'
  },
  {
    path: '/contracts',
    page: 'contracts',
    title: 'Quản lý hợp đồng',
    modulePath: './pages/contracts-page.js'
  },
  {
    path: '/meters',
    page: 'meters',
    title: 'Chỉ số điện nước',
    modulePath: './pages/meter-readings-page.js'
  },
  {
    path: '/services',
    page: 'services',
    title: 'Cấu hình dịch vụ',
    modulePath: './pages/services-page.js'
  },
  {
    path: '/invoices',
    page: 'invoices',
    title: 'Quản lý hóa đơn',
    modulePath: './pages/invoices-page.js'
  },
  {
    path: '/payments',
    page: 'payments',
    title: 'Quản lý thanh toán',
    modulePath: './pages/payments-page.js'
  },
  {
    path: '/debts',
    page: 'debts',
    title: 'Quản lý công nợ',
    modulePath: './pages/debts-page.js'
  },
  {
    path: '/reports',
    page: 'reports',
...
const NOT_FOUND_ROUTE = Object.freeze({
  ...
  modulePath: './pages/not-found-page.js'
});
...
async function loadPage(route, context) {
  ...
  if (!loadModule) {
    console.error(
      `Không tìm thấy module trang: ${route.modulePath}`
    );
